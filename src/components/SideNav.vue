...
<style lang="scss">
  .side {
    ...
    &__icon {
      ...
      &:hover {
        border-left: 4px solid #2BDA53;
      }

      &:hover img {
        filter: invert(85%) sepia(19%) saturate(5434%) hue-rotate(72deg) brightness(93%) contrast(83%);
      }
    }
  }
</style>